...
<div id="news" class="news">
    <div class="container">
        ...
        <div class="news-grids">
            ...
            <form action="${pageContext.request.contextPath}/GuiLoginServlet" method="post" class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    <label>ID号：</label>
                    <input class="form-control" type="text" name="gid" placeholder="请输入导游ID号" required="required">
                </div>
                <div class="form-group">
                    <label>密码：</label>
                ...
                <div class="form-group">
                    <button class="btn" style="background: #ffcc33">登录</button>
                </div>
            </form>
            <div class="clearfix"> </div>
        </div>
