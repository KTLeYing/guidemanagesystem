...
<%--                <li><a href="#news" class="scroll">导游中心</a></li>--%>
                <li><a href="${pageContext.request.contextPath}/view/frontweb/admin.jsp" class="active">管理员中心</a></li>
            </ul>
            <!-- script-for-menu -->
            <script>
...
<div class="contact-top">
    ...
    <div class="container">
        <div class="contact-info">
            <h3>管理员登录</h3>
            <p>管理员点击下面登录进去对各种信息进行操作</p>
        </div>
        <div class="mail-grids">
            <div class="col-md-offset-4">
                <a href="${pageContext.request.contextPath}/view/admin/login1.jsp" style="font-size: 50px">请点击此处登录...</a>
