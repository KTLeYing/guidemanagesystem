                        ...
                        <div class="content">
                            ...
                            <form method="post" action="login.html" class="form-validate" id="loginFrom">
                                <div class="form-group">
                                    <input id="login-username" type="text" name="adId" required data-msg="请输入账号" placeholder="账号"  class="input-material">
                                </div>
                                <div class="form-group">
                                    <input id="login-password" type="password" name="adPsw" required data-msg="请输入密码" placeholder="密码" class="input-material">
                                </div>
                            ...
                            <br />
                            <small>忘记密码?</small><a href="${pageContext.request.contextPath}/view/admin/findpsw.jsp" class="signup">&nbsp;找回</a>
                        </div>
                    </div>
                </div>
            </div>
