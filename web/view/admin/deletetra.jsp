            ...
            <div class="row core">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="${pageContext.request.contextPath}/DeleteTraServlet1" method="post" class="login-form">
                            <div class="form-group">
                                <label class="sr-only" for="form-password1">导游ID:</label>
                                <input type="text" name="gid" placeholder="请输入导游ID号" class="form-password form-control" id="form-password1">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password2">景点ID:</label>
                                <input type="text" name="vid" placeholder="请输入景点ID号" class="form-password form-control" id="form-password2">
                            </div>
