            ...
            <div class="row core">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="${pageContext.request.contextPath}/DeleteNewsServlet" method="post" class="login-form">
                            <div class="form-group">
                                <label class="sr-only" for="form-password1">新闻ID:</label>
                                <input type="text" name="nid" placeholder="请输入要删除的新闻ID号" class="form-password form-control" id="form-password1">
                            </div>
