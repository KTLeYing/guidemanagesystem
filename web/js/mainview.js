...
$(function(){
	...
	/*菜单json*/
	var menu = [{"id":"1","name":"主要操作","parentId":"0","url":"login.jsp","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"3","name":"查询信息","parentId":"1","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
						{"id":"4","name":"查询导游信息","parentId":"3","url":window.document.location.href.substring(0, window.document.location.href.indexOf(window.document.location.pathname)) + "/" + window.document.location.pathname.split("/")[1] + "/GuiListByPageServlet?curPage=1&rows=8","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"5","name":"查询景点信息","parentId":"3","url":window.document.location.href.substring(0, window.document.location.href.indexOf(window.document.location.pathname)) + "/" + window.document.location.pathname.split("/")[1] + "/ViewListByPageServlet?curPage=1&rows=8","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"6","name":"查询旅行信息","parentId":"3","url":window.document.location.href.substring(0, window.document.location.href.indexOf(window.document.location.pathname)) + "/" + window.document.location.pathname.split("/")[1] + "/TraListByPageServlet?curPage=1&rows=8","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"6","name":"添加信息","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
						{"id":"7","name":"添加导游信息","parentId":"6","url":"addgui.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"8","name":"添加景点信息","parentId":"6","url":"addview.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"9","name":"添加旅行信息","parentId":"6","url":"addtra.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
			        {"id":"10","name":"修改信息","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					   {"id":"11","name":"修改导游信息","parentId":"10","url":"altergui.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
					   {"id":"12","name":"修改景点信息","parentId":"10","url":"alterview.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
					   {"id":"13","name":"修改旅行信息","parentId":"10","url":"altertra.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
				    ]},
			        {"id":"14","name":"删除信息","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					   {"id":"15","name":"删除导游信息","parentId":"14","url":"deletegui.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
					   {"id":"16","name":"删除景点信息","parentId":"14","url":"deleteview.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
					   {"id":"17","name":"删除旅行信息","parentId":"14","url":"deletetra.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]}
				]},
				{"id":"2","name":"其他操作","parentId":"0","url":"","icon":"","order":"2","isHeader":"1","childMenus":[
					{"id":"18","name":"添加新闻","parentId":"2","url":"addnews.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
					{"id":"19","name":"删除新闻","parentId":"2","url":"deletenews.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
					{"id":"20","name":"修改密码","parentId":"2","url":"alterpsw.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					// {"id":"19","name":"修改密码","parentId":"2","url":"login.jsp","icon":"","order":"1","isHeader":"0","childMenus":[
